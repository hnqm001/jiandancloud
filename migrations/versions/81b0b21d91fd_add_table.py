...
Revision ID: 81b0b21d91fd
Revises: 
Create Date: 2019-07-07 18:12:43.321378
...
def upgrade():
    ...
    sa.Column('fileshare', sa.Boolean(), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
